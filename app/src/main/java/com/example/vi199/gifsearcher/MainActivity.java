...
class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.vi199.gifsearcher.R.layout.activity_main);

        request = Controller.getTrendingApi().getModel(API_KEY);

        recyclerView = (RecyclerView) findViewById(com.example.vi199.gifsearcher.R.id.posts_recycle_view);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);

        editText = (EditText) findViewById(com.example.vi199.gifsearcher.R.id.edit_text);
        imageButton = (ImageButton) findViewById(com.example.vi199.gifsearcher.R.id.image_button);
