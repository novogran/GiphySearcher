...
class PostsAdapter extends RecyclerView.Adapter<PostsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.example.vi199.gifsearcher.R.layout.post_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            webView = itemView.findViewById(com.example.vi199.gifsearcher.R.id.postitem_post);
